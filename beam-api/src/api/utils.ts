 ...
 * On Linux, Beam honors the xdg-terminal-exec specification: https://gitlab.freedesktop.org/terminal-wg/specifications/-/merge_requests/3/diffs
 *
 * @category System
 */
 ...
 * @example
 * ```typescript
 * await runInTerminal(['journalctl', '--user', '-u', '-f', 'beam']);
 * // or, inside a shell:
