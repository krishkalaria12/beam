  ...
  return (
    <div className="space-y-1.5">
      ...
      <Input
        ...
        className="h-10 w-full rounded-xl bg-[var(--launcher-card-hover-bg)] text-[14px] font-medium tracking-[-0.01em] text-foreground outline-none ring-1 ring-[var(--launcher-card-border)] transition-all focus:bg-[var(--launcher-card-hover-bg)] focus:ring-[var(--ring)] border-none"
      />
