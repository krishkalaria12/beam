...
export const STATIC_COMMANDS: CommandDescriptor[] = [
  ...
  },
  {
    ...
    keywords: ["ai", "chat", "assistant", "openai", "anthropic", "gemini", "openrouter"],
    endText: "open",
    icon: "sparkles",
    kind: "panel",
    scope: SCOPE_NORMAL_COMPRESSED,
  ...
  {
    id: "snippets.panel.open",
    title: "snippets",
    subtitle: "Text expansion and quick paste",
    keywords: ["snippet", "snippets", "text expander", "template", "cheat sheet", "keyword"],
    endText: "open",
    icon: "snippets",
    kind: "panel",
    scope: SCOPE_NORMAL_COMPRESSED,
  ...
  },
  {
    ...
    keywords: ["script", "scripts", "script commands", "shell", "bash", "automation", "terminal"],
    endText: "open",
    icon: "terminal",
    kind: "panel",
