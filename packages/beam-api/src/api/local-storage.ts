...
export namespace LocalStorage {
  ...
  export async function getItem<T extends LocalStorage.Value>(key: string): Promise<T | undefined> {
  ...
  export async function setItem(key: string, value: LocalStorage.Value): Promise<void> {
