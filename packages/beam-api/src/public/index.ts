...
export type { KeyEquivalent, KeyModifier } from "../api/keyboard.js";
export { Keyboard } from "../api/keyboard.js";
...
function Action(props: Record<string, unknown>) {
  ...
  if (RuntimeAction) {
    return React.createElement(RuntimeAction as React.ElementType, props);
  }
  return React.createElement("Action" as React.ElementType, props);
}
