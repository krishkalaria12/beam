  ...
  return (
    <div className="flex-1 min-h-0 overflow-y-auto rounded-xl border border-border/40 bg-background/40 p-4 shadow-sm">
      <div className="flex items-center gap-2 mb-3">
        ...
        <p className="text-launcher-xs font-bold uppercase tracking-wider text-muted-foreground/60">
          Terminal Output
        </p>
      </div>

      <div className="space-y-4 text-launcher-xs">
        {isRecordStatusLoading ? (
          <p className="text-muted-foreground/60 animate-pulse">Checking recorder status...</p>
        ) : (
          <div className="space-y-1.5">
            <p className="text-launcher-2xs font-semibold uppercase tracking-wider text-muted-foreground/50">
              Status Stream
            </p>
        ...
        {errorMessage && (
          <div className="space-y-1.5">
            <p className="text-launcher-2xs font-semibold uppercase tracking-wider text-destructive/50">
              Error
            </p>
