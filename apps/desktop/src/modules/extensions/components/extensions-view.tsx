      ...
      <div className="flex h-full w-full flex-col overflow-hidden bg-background text-foreground">
        <div className="flex shrink-0 items-center justify-between border-b border-[var(--ui-divider)] px-4 py-3">
          <div className="flex items-center gap-2 text-foreground/80 hover:text-foreground">
            ...
            <h2 className="text-launcher-xl font-semibold text-foreground">Community</h2>
          </div>
          <span className="text-launcher-sm tracking-wide text-muted-foreground">
          ...
          <div className="flex shrink-0 items-center gap-3 border-b border-[var(--ui-divider)] px-4 py-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-lg border border-[var(--ui-divider)] bg-[var(--launcher-card-bg)] py-2 pl-10 pr-4 text-launcher-sm text-foreground/90 outline-none transition-colors placeholder:text-muted-foreground focus:border-[var(--ring)]"
                autoFocus
              />
            </div>
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg border border-[var(--ui-divider)] bg-[var(--launcher-card-bg)] px-3 py-1.5 text-launcher-xs text-muted-foreground transition-colors hover:bg-[var(--launcher-card-hover-bg)] hover:text-foreground disabled:opacity-40"
            >
      ...
      >
        <DialogContent showCloseButton={false} className="sm:max-w-lg">
          ...
          <div className="space-y-3">
            ...
            <div className="text-launcher-xs leading-5 text-muted-foreground">
