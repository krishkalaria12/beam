...
pub fn get_handler() -> impl Fn(Invoke) -> bool {
    tauri::generate_handler![
        ...
        calculator::delete_calculator_history_entry,
        calculator::clear_calculator_history,
        calculator::get_pinned_calculator_history_timestamps,
        calculator::set_calculator_history_entry_pinned,
        clipboard::get_clipboard_history,
        clipboard::get_clipboard_history_entries,
        clipboard::search_clipboard_history,
        clipboard::delete_clipboard_history_entry,
        clipboard::clear_clipboard_history,
        clipboard::get_pinned_clipboard_entry_ids,
        clipboard::set_clipboard_entry_pinned,
        ...
        focus::create_focus_category,
        focus::update_focus_category,
        focus::delete_focus_category,
        focus::import_focus_categories,
        focus::start_focus_session,
        focus::edit_focus_session,
        focus::pause_focus_session,
        focus::resume_focus_session,
        focus::complete_focus_session,
        focus::toggle_focus_session,
        focus::snooze_focus_target,
        ...
        settings::get_ui_style,
        settings::set_ui_style,
        settings::get_base_color,
        settings::set_base_color,
        settings::get_launcher_opacity,
        settings::set_launcher_opacity,
        settings::list_font_families,
        settings::get_launcher_font_family,
        settings::set_launcher_font_family,
        settings::get_launcher_font_size,
        settings::set_launcher_font_size,
        settings::get_trigger_symbols,
        settings::set_trigger_symbols,
