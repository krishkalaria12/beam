// PORT: apps/desktop/src-tauri/src/todo/todo.rs
...
pub async fn create_todo(cx: &BeamContext, payload: CreateTodoPayload) -> Result<Todo> {
...
pub async fn update_todo(cx: &BeamContext, payload: UpdateTodoPayload) -> Result<()> {
...
pub async fn delete_todo(cx: &BeamContext, todo_id: String) -> Result<()> {
