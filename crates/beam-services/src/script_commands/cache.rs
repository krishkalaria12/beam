// PORT: apps/desktop/src-tauri/src/script_commands/cache.rs
...
pub(super) fn get_script_commands(cx: &BeamContext) -> Result<Vec<ScriptCommandSummary>> {
    ...
    let script_root = resolve_script_commands_directory(cx)?;
