...
// PORT: apps/desktop/src-tauri/src/applications/open_app.rs
// The Window parameter went away with the webview: the service opens the
// application; the dispatcher hides the launcher.
...
pub fn open_application(exec_path: String) -> Result<()> {
