...
// PORT: apps/desktop/src-tauri/src/state/mod.rs
// Tauri's managed state became a plain struct the binary constructs and
// passes explicitly; the async runtime is tokio.
...
/// Kicks off the file-search backend over the shared index.
