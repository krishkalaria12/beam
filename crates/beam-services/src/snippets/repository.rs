// PORT: apps/desktop/src-tauri/src/snippets/repository.rs
...
impl SnippetsRepository {
    ...
    pub async fn get_runtime_settings(&self, cx: &BeamContext) -> Result<SnippetRuntimeSettings> {
        let pool: SnippetDbPool = get_snippets_pool(cx).await?;
    ...
    pub async fn update_runtime_settings(
        ...
        let pool: SnippetDbPool = get_snippets_pool(cx).await?;
        let current = self.get_runtime_settings(cx).await?;
    ...
    pub async fn list_snippets(&self, cx: &BeamContext) -> Result<Vec<Snippet>> {
        let pool: SnippetDbPool = get_snippets_pool(cx).await?;
    ...
    pub async fn get_snippet_by_id(&self, cx: &BeamContext, id: &str) -> Result<Option<Snippet>> {
    ...
    pub async fn update_snippet(
        ...
        self.get_snippet_by_id(cx, &snippet_id)
            .await?
            .ok_or_else(|| {
    ...
    pub async fn delete_snippet(&self, cx: &BeamContext, id: &str) -> Result<()> {
    ...
    pub async fn increment_snippet_copied_count(
        ...
        self.record_snippet_usage(cx, snippet_id, true).await
    }
