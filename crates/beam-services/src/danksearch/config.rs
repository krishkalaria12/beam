// PORT: apps/desktop/src-tauri/src/danksearch/config.rs
...
pub fn ensure_config(cx: &BeamContext) -> Result<DSearchPaths, String> {
...
pub fn resolve_paths(cx: &BeamContext) -> Result<DSearchPaths, String> {
    let config_root = app
        .path()
        .app_config_dir()
